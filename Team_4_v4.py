# Nicholas Largent 10/16/2025
# This is to be used with main.py
# Updated from v3 to now have a function that takes the file path of the flash drive
# This is to meet the requirement of few CLI inputs to get started for the demo
...
def run(flash_drive_file_path):
    target_img = process_images(flash_drive_file_path, debug=False)
